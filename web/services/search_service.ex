defmodule Publit.SearchService do
  ...
  @base_sql """
  select o.id::text, o.name, o.geom, o.tags, o.address, o.open, o.rating, o.rating_count, o.description
  ...
  defp map_results(rows) do
    Enum.map(rows, fn(row) ->
      [id, name, geom, tags, address, open, rating, rating_count, desc] = row
