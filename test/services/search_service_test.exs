defmodule Publit.SearchServiceTest do
  ...
  def create_orgs do
    [
      # summa pacha
      create_org(%{name: "org 1", geom: coords(-63.876047,-18.1787804), rating: 4, tags: [%{text: "vegetariano", count: 10}, %{text: "vegano", count: 7}] }),
      #
      create_org(%{name: "org 2", geom: coords(-63.8732718,-18.1767489), rating: 3, tags: [%{text: "carne", count: 15}, %{text: "vegetariano", count: 1}, %{text: "parrilla", count: 5}] }),
      # Achira
      create_org(%{name: "org 3", geom: coords(-63.8210238,-18.1650556), rating: 5, tags: [%{text: "pizza", count: 20}, %{text: "pasta", count: 5}] }),
      create_org(%{name: "org 4", geom: coords(-63.8660898,-18.1781923), rating: 2, tags: [%{text: "pollo", count: 4}] }),
      # Timboy
      create_org(%{name: "org 5", geom: coords(-63.8732718,-18.1767489), rating: 3, tags: [] })
    ]
  end
