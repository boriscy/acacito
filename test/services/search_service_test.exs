defmodule Publit.SearchServiceTest do
  ...
  defp create_orgs do
    [
      # summa pacha
      create_org(%{name: "org 1", geom: coords(-18.1787804,-63.876047), rating: 4, tags: [%{text: "vegeratariano", count: 10}, %{text: "vegano", count: 7}] }),
      #
      create_org(%{name: "org 2", geom: coords(-18.1767489,-63.8732718), rating: 3, tags: [%{text: "carne", count: 15}, %{text: "vegeratiano", count: 1}, %{text: "parrilla", count: 5}] }),
      # Achira
